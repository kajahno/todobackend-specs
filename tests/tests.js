...
describe('Update Todo Item', function(){
    ...
    beforeEach(function(done){
        post(url, { title: 'Walk the dog' })
            .then(function(res){
                // assert(res, "body.completed").to.be.false;
...
// POST requests with data and return promise
...
// GET requests with data and return promise
function get(url){
...
// DELETE requests with data and return promise
function del(url){
    return request.del(url).end();
}

// UPDATE requests with data and return promise
